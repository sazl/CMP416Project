...
insert into exams(courseid, eventid, grade) values (1, 1, 4.5);
insert into exams(courseid, eventid, grade) values (1, 2, 2.3);
insert into exams(courseid, eventid, grade) values (2, 3, 3.2);
